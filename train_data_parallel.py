# python -m torch.distributed.launch --nproc_per_node=8 --use_env train_data_parallel.py
...
def main(args):
    ...
    model.to(device)
    # data_parallel转为DDP模型 ,设置find_unused_parameters=True
...
if __name__ == '__main__':
    ...
    # data_parallel 初始化各进程环境，准备进行分布式训练
