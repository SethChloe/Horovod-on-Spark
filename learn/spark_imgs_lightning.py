...
def train_model(args):
    ...
    train_df = img_anger.unionAll(img_fear) \
        # .unionAll(img_contempt).unionAll(img_disgust).unionAll(img_happiness) \
    # .unionAll(img_neutral).unionAll(img_sadness).unionAll(img_surprise)
    ...
    class Deep_Emotion(LightningModule):
