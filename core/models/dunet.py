...
__all__ = ['DUNet', 'get_dunet', 'get_dunet_resnet50_pascal_voc',
           'get_dunet_resnet101_pascal_voc', 'get_dunet_resnet152_pascal_voc','get_dunet_resnet50_pascal_voc_jibuti']
#,
...
class DUNet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=True, pretrained_base=True, **kwargs):
        ...
        self.conv7_3 = nn.Conv2d(7, 3, kernel_size=1, stride=1)  # 用于处理哨兵数据时使用
        if aux:
...
def get_dunet_resnet50_pascal_voc_jibuti(**kwargs):
    return get_dunet('pascal_voc_jibuti', 'resnet50', **kwargs)
