...
parser.add_argument('--train-dir', default=os.path.expanduser('/root/autodl-tmp/flower_data/train'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('/root/autodl-tmp/flower_data/val'),
...
if __name__ == '__main__':
    ...
    args.allreduce_batch_size = args.batch_size * args.batches_per_allreduce #TODO:batches_per_allreduce
