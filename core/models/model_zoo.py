...
from .lednet import *
from .dfanet import *
from .deeplabv3_geofeature import  *
...
_models = {
    ...
    'deeplabv3_geofeat_resnet50_voc': get_deeplabv3_geofeat_resnet50_voc,
    ...
    'dunet_resnet50_pascal_voc_jibuti':get_dunet_resnet50_pascal_voc_jibuti,
}
...
def get_segmentation_model(model, **kwargs):
    models = {
        ...
        'deeplabv3_geofeat':get_deeplabv3_geofeat,
