...
def get_color_pallete(npimg, dataset='pascal_voc'):
    ...
    """
    # recovery boundary
    if dataset in ('pascal_voc', 'pascal_aug','pascal_voc_jibuti'):
        npimg[npimg == -1] = 255
    # put colormap
    if dataset == 'ade20k':
        npimg = npimg + 1
...
#生成所有的标记图
mask = gdal.Open('C:/Users/51440\Desktop/WLKdata/annontation_all2.tif').ReadAsArray()
mask = get_color_pallete(mask, 'yjs')
mask.save(os.path.join('C:/Users/51440/OneDrive - cug.edu.cn/IEEE JSTARS 岩石分类', 'annotation_label.tif'))